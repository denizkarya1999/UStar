    ...
    companion object {
        ...
        fun loadModel(
            ...
            return try {
                ...
                Log.i("Orientation_ResNet18", "✅ Model loaded successfully from $assetName")
                Orientation_ResNet18(module)
            } catch (e: Exception) {
                Log.e("Orientation_ResNet18", "❌ Failed to load model: ${e.message}", e)
                null
            }
        }
